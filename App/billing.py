...
def billing():
    			...
    			if(email==""):
    				...
    				if msg:
    					...
    					try:
    						...
    						messagebox.showinfo('RMS','Data was entered successfully')
    						root.destroy()
    						workspace1()
    					except:
    	...
    	def database1():
    		...
    		def export_exel():
    			try :
    			    ...
    			    messagebox.showerror('RMS','Failed to connect server, Please contact your administrator')
    ...
    #---------------------------------------///////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\------------------------------
    	...
    	class main:
    		...
    		def exits():
    			msg=messagebox.askyesno('RMS','Do You Want To Exit ?');
    			if msg:
    				root.destroy()
